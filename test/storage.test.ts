...
import { clearSearch, getSearch, getStorage, normalizePath, saveSearch, storageKey } from "../src/utils/storage";
...
describe("storage utils", () => {
  ...
  it("builds storage key", () => {
    expect(storageKey("/products/")).toBe("react-list-query-preserve:/products");
